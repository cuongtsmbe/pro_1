...
class Reviews extends Widget_Base {
	...
	public function get_name() {
		return 'xts_single_product_reviews';
	}
	...
	public function get_title() {
		return esc_html__( 'Reviews', 'xts-theme' );
	}
	...
	protected function render() {
		...
		xts_single_product_reviews_template( $this->get_settings_for_display() );
