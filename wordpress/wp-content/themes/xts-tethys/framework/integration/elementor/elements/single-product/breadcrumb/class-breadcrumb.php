...
class Breadcrumb extends Widget_Base {
	...
	public function get_name() {
		return 'xts_single_product_breadcrumb';
	}
	...
	public function get_title() {
		return esc_html__( 'WooCommerce breadcrumb', 'xts-theme' );
	}
	...
	protected function render() {
		...
		xts_single_product_breadcrumb_template( $this->get_settings_for_display() );
