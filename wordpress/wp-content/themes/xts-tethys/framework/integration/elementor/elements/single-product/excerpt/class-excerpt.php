...
class Excerpt extends Widget_Base {
	...
	public function get_name() {
		return 'xts_single_product_excerpt';
	}
	...
	public function get_title() {
		return esc_html__( 'Short description', 'xts-theme' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				'name'     => 'excerpt_custom_typography',
	...
	protected function render() {
		...
		xts_single_product_excerpt_template( $this->get_settings_for_display() );
...
Plugin::instance()->widgets_manager->register( new Excerpt() );
