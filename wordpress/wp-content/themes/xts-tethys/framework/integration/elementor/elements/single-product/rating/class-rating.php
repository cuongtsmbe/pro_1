...
class Rating extends Widget_Base {
	...
	public function get_name() {
		return 'xts_single_product_rating';
	}
	...
	public function get_title() {
		return esc_html__( 'Rating', 'xts-theme' );
	}
	...
	protected function render() {
		...
		xts_single_product_rating_template( $this->get_settings_for_display() );
