...
class Countdown extends Widget_Base {
	...
	public function get_name() {
		return 'xts_single_product_countdown';
	}
	...
	public function get_title() {
		return esc_html__( 'Single product countdown', 'xts-theme' );
	}
	...
	public function get_icon() {
		return 'xf-woo-el-countdown-timer';
	}
	...
	protected function render() {
		...
		xts_single_product_countdown_template( $this->get_settings_for_display() );
