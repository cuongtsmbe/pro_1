...
class Nav extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Navigation', 'xts-theme' );
	}
	...
	protected function render() {
		...
		xts_single_product_nav_template( $this->get_settings_for_display() );
