...
class Action_Buttons extends Widget_Base {
	...
	public function get_name() {
		return 'xts_single_product_action_buttons';
	}
	...
	public function get_title() {
		return esc_html__( 'Action buttons', 'xts-theme' );
	}
	...
	public function get_icon() {
		return 'xf-woo-el-action-buttons';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'    => 'xts_buttons',
				'options' => xts_get_available_options( 'single_product_action_buttons_style_elementor' ),
				'default' => 'inline',
			]
		);
	...
	protected function render() {
		...
		xts_single_product_action_buttons_template( $this->get_settings_for_display() );
...
Plugin::instance()->widgets_manager->register( new Action_Buttons() );
