...
if ( ! function_exists( 'xts_gutenberg_show_widgets' ) ) {
	/**
	 * Gutenberg show widgets.
	 *
	 * @return array
	 */
	function xts_gutenberg_show_widgets() {
		return array();
	}

	add_action( 'widget_types_to_hide_from_legacy_widget_block', 'xts_gutenberg_show_widgets', 100 );
}
...
if ( ! function_exists( 'xts_gutenberg_editor_custom_styles' ) ) {
	...
	function xts_gutenberg_editor_custom_styles() {
		...
		<style>
			div.block-editor .editor-styles-wrapper {
				...
				<?php if ( ! empty( $content_typography[0]['font-size'] ) ) : ?>
					font-size: <?php echo esc_attr( $content_typography[0]['font-size'] ); ?>;
				<?php endif; ?>
            ...
            div.block-editor .editor-styles-wrapper blockquote:not(.is-style-large) {
	 ...
	 add_action( 'admin_head', 'xts_gutenberg_editor_custom_styles' );
}
