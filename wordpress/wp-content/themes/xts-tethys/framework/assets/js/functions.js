		...
		var xtsFrameworkAdmin = {
			...
			optionsPresets: function() {
				...
				$presetsWrapper.on('click', '.xts-add-new-preset', function(e) {
					...
					initSelect2();
				}).on('click', '.xts-edit-preset-rule, .xts-presets-title-inner:not(.xts-edit)', function(e) {
					e.preventDefault();
					...
					$presetsWrapper.find('.xts-presets-title span').text('').append('<input type="text" class="xts-name-preset" value="' + $form.val() + '">');
