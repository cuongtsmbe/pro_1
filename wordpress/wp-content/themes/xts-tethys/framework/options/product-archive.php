...
Options::add_field(
	array(
		...
		'type'        => 'switcher',
		'name'        => esc_html__( 'Keep page number in the URL', 'xts-theme' ),
		'description' => esc_html__( 'Enable this option to keep the page number in the browser URL when you use AJAX pagination.', 'xts-theme' ),
		'group'       => esc_html__( 'Pages', 'xts-theme' ),
		'section'     => 'product_archive_layout_section',
		'default'     => '1',
		'priority'    => 160,
...
Options::add_field(
	array(
		'id'          => 'pagination_infinite_offset',
		'name'        => esc_html__( 'Infinite scrolling offset', 'xts-theme' ),
		'description' => esc_html__( 'You can trigger the loading of the next page earlier before scrolling to the "Load more" button. Specify this offset value in pixels.', 'xts-theme' ),
		'tags'        => esc_html__( 'pagination infinite scrolling offset', 'xts-theme' ),
		'group'       => esc_html__( 'Pages', 'xts-theme' ),
		'type'        => 'range',
		'section'     => 'product_archive_layout_section',
		'min'         => 400,
...
Options::add_field(
	array(
		...
		'section'     => 'product_archive_page_title_section',
		'default'     => xts_get_default_value( 'page_title_shop_categories' ),
		'priority'    => 30,
	)
);
...
Options::add_field(
	array(
		...
		'default'     => xts_get_default_value( 'shop_filters_area' ),
		'priority'    => 10,
	)
);
