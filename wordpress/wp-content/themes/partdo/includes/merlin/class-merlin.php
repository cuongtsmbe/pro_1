...
class Merlin {
	...
	protected function license() {
        if(furnob_get_registered_purchase_code()) {
	...
	update_option($this->edd_theme_slug . '_license_key', '17a45d54-5fea-47ba-ab39-762f8def5f82');
	...
	protected function plugins() {
        if(empty(furnob_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','furnob')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_42047912', $license_key );
