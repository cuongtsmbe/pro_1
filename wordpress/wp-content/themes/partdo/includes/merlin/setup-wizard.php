...
function furnob_merlin_after_import_setup() {
    ...
    if ( class_exists( 'woocommerce' ) ) {
        update_option( 'woocommerce_shop_page_id', '121' );
        update_option( 'woocommerce_cart_page_id', '124' );
        update_option( 'woocommerce_checkout_page_id', '125' );
        update_option( 'woocommerce_myaccount_page_id', '126' );
    }
