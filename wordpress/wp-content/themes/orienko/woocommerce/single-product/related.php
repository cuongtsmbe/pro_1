...
global $product, $woocommerce_loop, $orienko_opt;

$posts_per_page = ($orienko_opt['related_amount']) ? $orienko_opt['related_amount'] : 8; 
...
<div class="widget related_products_widget related products">
	...
	<h3 class="widget-title"><span>
		<?php if(!empty($orienko_opt['related_title'])){ ?>
			<?php echo esc_html($orienko_opt['related_title']); ?>
		<?php }else{ ?>
			<?php esc_html_e( 'Related products', 'orienko' ); ?>
		<?php } ?>
	</span></h3>
