...
<div class="products-block shop-products products grid-view">
	...
	<?php while ( $loop->have_posts() ) : $loop->the_post(); global $product; ?>
		<div class="item-col <?php echo esc_attr($class_column); ?> product <?php echo (!empty($showon_effect)) ? 'wow ' . $showon_effect : ''; ?>" data-wow-duration="0.5s" data-wow-delay="<?php echo esc_attr($_delay); ?>ms">
			<?php 
