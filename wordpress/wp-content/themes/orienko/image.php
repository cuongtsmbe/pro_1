							...
							<header class="entry-header">
								...
								<div class="entry-meta">
									<?php
										...
										printf(wp_kses(__('Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>', 'orienko'), array('span', 'time', 'a')),
								...
								<ul id="image-navigation" class="image-navigation pager">
									<li class="nav-previous previous"><?php previous_image_link(false, wp_kses(__('<span class="meta-nav">&larr;</span> Previous', 'orienko'), array('span'))); ?></li>
									<li class="nav-next next"><?php next_image_link(false, wp_kses(__('Next <span class="meta-nav">&rarr;</span>', 'orienko'), array('span'))); ?></li>
								</ul><!-- #image-navigation -->
							</header><!-- .entry-header -->
							...
							<div class="entry-content">
								<div class="entry-attachment">
									<div class="attachment">
										<?php orienko_bootstrap_attached_image(); ?> 
									</div><!-- .attachment -->
